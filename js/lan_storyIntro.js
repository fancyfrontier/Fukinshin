$(window).on('load', function() {
	...
	if(getCookie("intro") == "Sunday"){
		...
		$(".STORY_INTRO_content_other").load("../Section/StoryIntro/StoryIntro_Sunday/storyIntro_content_other.html");
		...
		$(".STORY_INTRO_content_other").load("../Section/StoryIntro/StoryIntro_Star/storyIntro_content_other.html");
	}
